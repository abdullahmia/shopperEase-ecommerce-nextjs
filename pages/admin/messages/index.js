...
const Messages = () => {
    return (
        <DashboardLayout>
            <Head>
                <title>Messages | ShopperEase Admin</title>
            </Head>
            ...
            <main className='container px-4'>
                <div className='flex items-center justify-between py-4'>
                    <div className='space-y-1'>
                        ...
                        <h2 className='text-[#333] font-[600] text-2xl'>Messages</h2>
                    </div>
                </div>
                ...
                <div className='mt-4 border'>
                    <div className='p-3'>
                        <div className='flex items-center gap-1 border px-3'>
                            ...
                            <input type="text" placeholder='Start typing email to search for messages' className='flex-1 w-full bg-white text-xs focus:outline-none focus:border-none py-3' />
                        </div>
                    </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            Hey there, Im interested in buying your product. Please get back to me as soon as possible.
                                        </td>
