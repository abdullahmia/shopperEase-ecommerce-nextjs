            ...
            <main className='container px-4'>
                <div className='flex items-center justify-between py-4'>
                    <div>
                        ...
                        <h2 className='text-[#333] font-[600] text-2xl'>Orders</h2>
                    </div>
                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <span className='capitalize bg-[#DEF2D0] px-2 py-1 text-xs'>yes</span>
                                        </td>
                                        <td class="px-6 py-4">
                                            <span className='capitalize bg-[#D9ECFF] px-2 py-1 text-xs'>shipped</span>
                                        </td>
                                        <td class="px-6 py-4">
                                            8
                                        </td>
                                        ...
                                        <td class="flex items-center px-6 py-4 space-x-3">
                                            ...
                                            <button onClick={deleteOrderHandler} class="font-medium text-red-600 hover:underline">Remove</button>
                                        </td>
                                    </tr>
