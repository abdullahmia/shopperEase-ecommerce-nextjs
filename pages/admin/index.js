...
const index = () => {
  return (
    <DashboardLayout>
      <Head>
        <title>Dashboard | ShopperEase</title>
      </Head>
      <main className='container px-4'>
        <div class="pt-6 px-4">
          <div class="mb-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            <div class="bg-white border p-4 sm:p-6 xl:p-8 ">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <span class="text-2xl sm:text-3xl leading-none font-bold text-[#333]">2,340</span>
                  <h3 class="text-[15px] font-normal text-gray-500">Total Sell</h3>
                </div>
            ...
            <div class="bg-white border p-4 sm:p-6 xl:p-8 ">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <span class="text-2xl sm:text-3xl leading-none font-bold text-[#333]">5,355</span>
                  <h3 class="text-[15px] font-normal text-gray-500">Average order value</h3>
                </div>
                <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                  32.9%
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-white border p-4 sm:p-6 xl:p-8 ">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <span class="text-2xl sm:text-3xl leading-none font-bold text-[#333]">385</span>
                  <h3 class="text-[15px] font-normal text-gray-500">Total orders</h3>
                </div>
