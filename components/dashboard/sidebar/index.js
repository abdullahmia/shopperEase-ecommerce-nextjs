            ...
            <div class="flex flex-col justify-between flex-1 mt-10">
                <nav class="-mx-3 space-y-6 ">
                    <div class="space-y-3 ">
                        ...
                        <a class="flex items-center px-3 py-2 text-gray-100 transition-colors duration-300 transform rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="space-y-3 ">
                        <label class="px-3 text-xs uppercase text-gray-400">Customization</label>
