        ...
        <div className='lg:col-span-10 col-span-12'>
              ...
              >
                  <SwiperSlide className=''>
                      <div className='lg:h-[425px] h-[300px] w-full flex items-center px-5' style={{ background: `url(${sliceImg1.src})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                          <div className='container leading-none space-y-2'>
                              <p className='text-[16px] uppercase'>ShoperEase online store</p>
                              <h1 className='lg:text-[60px] text-[20px] text-[#333333] font-semibold'>Season Fashion</h1>
                              <h2 className='lg:text-[60px] text-[20px] text-[#333333]'>Collection</h2>
                  ...
                  <SwiperSlide className=''>
                      <div className='lg:h-[425px] h-[300px] flex items-center lg:px-36 px-5' style={{ background: `url(${sliceImg2.src})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                          <div className='container flex items-center justify-between'>
                              <div className='lg:block hidden'>
                                  <Image src={watchImg} height={300} width={300} alt="Watch" />
                              </div>
                              <div className='leading-none space-y-2'>
                                  <p className='text-[20px] uppercase text-[#42a4e8]'>Special Offer</p>
                                  <h1 className='lg:text-[50px] text-[20px] font-semibold text-white uppercase'>Big OFfer</h1>
                  ...
                  <SwiperSlide className=''>
                      <div className='lg:h-[425px] h-[300px] flex items-center lg:px-9 px-5' style={{ background: `url(${sliceImg3.src})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                          <div className='container flex items-center justify-between'>
                              <div className='lg:block hidden'>
